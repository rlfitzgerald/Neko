...
Source: "/home/andrew/.virtualenvs/cardet\lib\*-c.lib"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: core;
Source: "/home/andrew/.virtualenvs/cardet\lib\*-c.dll"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: core;
Source: "/home/andrew/.virtualenvs/cardet\include\*"; DestDir: "{app}\include"; Flags: ignoreversion recursesubdirs createallsubdirs; Components: core;
Source: "/home/andrew/.virtualenvs/cardet\share\nitf\plugins\*.dll"; DestDir: "{app}\share\nitf\plugins"; Flags: ignoreversion recursesubdirs; Components: plugins\tres;
...
Source: "/home/andrew/.virtualenvs/cardet\tests\nitf\*.exe"; DestDir: "{app}\tests"; Flags: ignoreversion recursesubdirs; Components: tests;
Source: "/home/andrew/.virtualenvs/cardet\bin\*.exe"; DestDir: "{app}\bin"; Flags: ignoreversion recursesubdirs; Components: apps;
Source: "/home/andrew/.virtualenvs/cardet\bin\mex\*.mex*"; DestDir: "{app}\bin\mex"; Flags: ignoreversion recursesubdirs skipifsourcedoesntexist; Components: matlab;
Source: "..\..\java\libs\*.jar"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: java;
Source: "/home/andrew/.virtualenvs/cardet\lib\*.jar"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: java;
Source: "..\..\java\libs\*.jar"; DestDir: "{app}\share\ImageJ\plugins\nitf"; Flags: ignoreversion; Components: java\imagej;
Source: "/home/andrew/.virtualenvs/cardet\lib\*.jar"; DestDir: "{app}\share\ImageJ\plugins\nitf"; Flags: ignoreversion; Components: java\imagej;
Source: "/home/andrew/.virtualenvs/cardet\lib\nitf.imageio*.jar"; DestDir: "{app}\share\ImageJ\plugins\nitf"; Flags: ignoreversion; Components: java\imagej;
...
Source: "/home/andrew/.virtualenvs/cardet\lib\*-c++.lib"; DestDir: "{app}\lib"; Flags: ignoreversion; Components: cpp;
